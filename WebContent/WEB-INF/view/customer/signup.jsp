...
<form id="form" name="form" >
  ...
  <input type="text" id="address" placeholder="주소" aria-describedby="sizing-addon1">
    </div>
    
   <div class="input-group input-group-lg"> 
  <span class="input-group-addon" id="city">면읍구군시</span>
  <input type="text" id="city" placeholder="면읍구군시" aria-describedby="sizing-addon1">
      </div>
